...
When users call a custom slash command, you have to look for the markdown file, `.codex/commands/{command}.md`, then execute the contents of that file as the block of operations.

## Simulated Subagents

Simulated subagents are specialized AI assistants that can be invoked to handle specific types of tasks. In this case, it can be appear something like custom slash commands simply. Simulated subagents can be called by custom slash commands.

When users call a simulated subagent, it will look for the corresponding markdown file, `.codex/subagents/{subagent}.md`, and execute its contents as the block of operations.

For example, if the user instructs `Call planner subagent to plan the refactoring`, you have to look for the markdown file, `.codex/subagents/planner.md`, and execute its contents as the block of operations.# CLAUDE.md
